...
namespace PeluqueriaApp
{
    partial class CitasForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            CitasDataGrid = new DataGridView();
            EditarBtn = new Button();
            EliminarBtn = new Button();
            pbLogo = new PictureBox();
            LateralPanel.SuspendLayout();
            CapcaleraPanel.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)CitasDataGrid).BeginInit();
            ...
            // CitasBoto
            // 
            CitasBoto.BackColor = Color.FromArgb(255, 140, 0);
            CitasBoto.Cursor = Cursors.Hand;
            CitasBoto.FlatAppearance.BorderSize = 0;
            CitasBoto.FlatStyle = FlatStyle.Flat;
            CitasBoto.Font = new Font("Segoe UI", 11F, FontStyle.Bold, GraphicsUnit.Point);
            CitasBoto.ForeColor = Color.White;
            ...
            TitolAppLbl.Size = new Size(181, 30);
            TitolAppLbl.TabIndex = 0;
            TitolAppLbl.Text = "Gestión de Citas";
            // 
            // BienvenidaLbl
            // 
            ...
            TitolPaginaLbl.Size = new Size(212, 32);
            TitolPaginaLbl.TabIndex = 5;
            TitolPaginaLbl.Text = "Administrar Citas";
            // 
            // FiltroFechaCombo
            // 
            FiltroFechaCombo.BackColor = Color.White;
            FiltroFechaCombo.DropDownStyle = ComboBoxStyle.DropDownList;
            FiltroFechaCombo.Font = new Font("Segoe UI", 11F, FontStyle.Regular, GraphicsUnit.Point);
            FiltroFechaCombo.Items.AddRange(new object[] { "Todas", "Hoy", "Esta Semana", "Este Mes" });
            FiltroFechaCombo.Location = new Point(290, 160);
            FiltroFechaCombo.Name = "FiltroFechaCombo";
            FiltroFechaCombo.Size = new Size(200, 28);
            FiltroFechaCombo.TabIndex = 4;
            FiltroFechaCombo.SelectedIndexChanged += FiltroFechaCombo_SelectedIndexChanged;
            // 
            // CrearCitaBtn
            // 
            CrearCitaBtn.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            CrearCitaBtn.BackColor = Color.FromArgb(139, 90, 60);
            CrearCitaBtn.Cursor = Cursors.Hand;
            CrearCitaBtn.FlatAppearance.BorderSize = 0;
            CrearCitaBtn.FlatStyle = FlatStyle.Flat;
            CrearCitaBtn.Font = new Font("Segoe UI", 11F, FontStyle.Bold, GraphicsUnit.Point);
            CrearCitaBtn.ForeColor = Color.White;
            CrearCitaBtn.Location = new Point(1120, 157);
            CrearCitaBtn.Name = "CrearCitaBtn";
            CrearCitaBtn.Size = new Size(180, 40);
            CrearCitaBtn.TabIndex = 3;
            CrearCitaBtn.Text = "➕ Crear Cita";
            CrearCitaBtn.UseVisualStyleBackColor = false;
            CrearCitaBtn.Click += CrearCitaBtn_Click;
            // 
            // CitasDataGrid
            // 
            CitasDataGrid.AllowUserToAddRows = false;
            CitasDataGrid.AllowUserToDeleteRows = false;
            CitasDataGrid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            CitasDataGrid.BackgroundColor = Color.White;
            CitasDataGrid.BorderStyle = BorderStyle.None;
            ...
            CitasDataGrid.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
            ...
            CitasDataGrid.DefaultCellStyle = dataGridViewCellStyle2;
            CitasDataGrid.EnableHeadersVisualStyles = false;
            CitasDataGrid.GridColor = Color.FromArgb(240, 240, 240);
            CitasDataGrid.Location = new Point(290, 220);
            CitasDataGrid.MultiSelect = false;
            CitasDataGrid.Name = "CitasDataGrid";
            CitasDataGrid.ReadOnly = true;
            CitasDataGrid.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            CitasDataGrid.Size = new Size(1070, 440);
            CitasDataGrid.TabIndex = 2;
            // 
            // EditarBtn
            // 
            ...
            // pbLogo
            // 
            pbLogo.Location = new Point(82, 5);
            pbLogo.Name = "pbLogo";
            ...
            Controls.Add(CitasDataGrid);
            Controls.Add(CrearCitaBtn);
            Controls.Add(FiltroFechaCombo);
            ...
            Text = "Peluquería Bernat Sarriá - Citas";
            LateralPanel.ResumeLayout(false);
            CapcaleraPanel.ResumeLayout(false);
            CapcaleraPanel.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)CitasDataGrid).EndInit();
