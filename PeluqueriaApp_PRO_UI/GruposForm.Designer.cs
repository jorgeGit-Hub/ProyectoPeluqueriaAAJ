...
namespace PeluqueriaApp
{
    partial class GruposForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            BuscarGruposTxt = new TextBox();
            BuscarBtn = new Button();
            CrearGrupoBtn = new Button();
            GruposDataGrid = new DataGridView();
            EditarBtn = new Button();
            EliminarBtn = new Button();
            pbLogo = new PictureBox();
            LateralPanel.SuspendLayout();
            CapcaleraPanel.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)GruposDataGrid).BeginInit();
            ...
            // GruposBoto
            // 
            GruposBoto.BackColor = Color.FromArgb(255, 140, 0);
            GruposBoto.Cursor = Cursors.Hand;
            GruposBoto.FlatAppearance.BorderSize = 0;
            GruposBoto.FlatStyle = FlatStyle.Flat;
            GruposBoto.Font = new Font("Segoe UI", 11F, FontStyle.Bold, GraphicsUnit.Point);
            GruposBoto.ForeColor = Color.White;
            ...
            TitolAppLbl.Size = new Size(205, 30);
            TitolAppLbl.TabIndex = 0;
            TitolAppLbl.Text = "Gestión de Grupos";
            // 
            // BienvenidaLbl
            // 
            ...
            TitolPaginaLbl.Size = new Size(240, 32);
            TitolPaginaLbl.TabIndex = 6;
            TitolPaginaLbl.Text = "Administrar Grupos";
            // 
            // BuscarGruposTxt
            // 
            BuscarGruposTxt.BackColor = Color.White;
            BuscarGruposTxt.BorderStyle = BorderStyle.FixedSingle;
            BuscarGruposTxt.Font = new Font("Segoe UI", 11F, FontStyle.Regular, GraphicsUnit.Point);
            BuscarGruposTxt.ForeColor = Color.FromArgb(45, 35, 30);
            BuscarGruposTxt.Location = new Point(290, 160);
            BuscarGruposTxt.Name = "BuscarGruposTxt";
            BuscarGruposTxt.Size = new Size(400, 27);
            BuscarGruposTxt.TabIndex = 5;
            // 
            // BuscarBtn
            // 
            ...
            // CrearGrupoBtn
            // 
            CrearGrupoBtn.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            CrearGrupoBtn.BackColor = Color.FromArgb(139, 90, 60);
            CrearGrupoBtn.Cursor = Cursors.Hand;
            CrearGrupoBtn.FlatAppearance.BorderSize = 0;
            CrearGrupoBtn.FlatStyle = FlatStyle.Flat;
            CrearGrupoBtn.Font = new Font("Segoe UI", 11F, FontStyle.Bold, GraphicsUnit.Point);
            CrearGrupoBtn.ForeColor = Color.White;
            CrearGrupoBtn.Location = new Point(1120, 157);
            CrearGrupoBtn.Name = "CrearGrupoBtn";
            CrearGrupoBtn.Size = new Size(180, 40);
            CrearGrupoBtn.TabIndex = 3;
            CrearGrupoBtn.Text = "➕ Crear Grupo";
            CrearGrupoBtn.UseVisualStyleBackColor = false;
            CrearGrupoBtn.Click += CrearGrupoBtn_Click;
            // 
            // GruposDataGrid
            // 
            GruposDataGrid.AllowUserToAddRows = false;
            GruposDataGrid.AllowUserToDeleteRows = false;
            GruposDataGrid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            GruposDataGrid.BackgroundColor = Color.White;
            GruposDataGrid.BorderStyle = BorderStyle.None;
            ...
            GruposDataGrid.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
            ...
            GruposDataGrid.DefaultCellStyle = dataGridViewCellStyle2;
            GruposDataGrid.EnableHeadersVisualStyles = false;
            GruposDataGrid.GridColor = Color.FromArgb(240, 240, 240);
            GruposDataGrid.Location = new Point(290, 220);
            GruposDataGrid.MultiSelect = false;
            GruposDataGrid.Name = "GruposDataGrid";
            GruposDataGrid.ReadOnly = true;
            GruposDataGrid.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            GruposDataGrid.Size = new Size(1070, 440);
            GruposDataGrid.TabIndex = 2;
            // 
            // EditarBtn
            // 
            ...
            // pbLogo
            // 
            pbLogo.Location = new Point(76, 5);
            pbLogo.Name = "pbLogo";
            ...
            Controls.Add(GruposDataGrid);
            Controls.Add(CrearGrupoBtn);
            Controls.Add(BuscarBtn);
            Controls.Add(BuscarGruposTxt);
            ...
            Text = "Peluquería Bernat Sarriá - Grupos";
            LateralPanel.ResumeLayout(false);
            CapcaleraPanel.ResumeLayout(false);
            CapcaleraPanel.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)GruposDataGrid).EndInit();
