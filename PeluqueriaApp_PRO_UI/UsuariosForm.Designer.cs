...
namespace PeluqueriaApp
{
    partial class UsuariosForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            BuscarUsuariosTxt = new TextBox();
            BuscarBtn = new Button();
            CrearUsuarioBtn = new Button();
            UsuariosDataGrid = new DataGridView();
            EditarBtn = new Button();
            EliminarBtn = new Button();
            pbLogo = new PictureBox();
            LateralPanel.SuspendLayout();
            CapcaleraPanel.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)UsuariosDataGrid).BeginInit();
            ...
            // UsuariosBoto
            // 
            UsuariosBoto.BackColor = Color.FromArgb(255, 140, 0);
            UsuariosBoto.Cursor = Cursors.Hand;
            UsuariosBoto.FlatAppearance.BorderSize = 0;
            UsuariosBoto.FlatStyle = FlatStyle.Flat;
            UsuariosBoto.Font = new Font("Segoe UI", 11F, FontStyle.Bold, GraphicsUnit.Point);
            UsuariosBoto.ForeColor = Color.White;
            ...
            TitolAppLbl.Size = new Size(219, 30);
            TitolAppLbl.TabIndex = 0;
            TitolAppLbl.Text = "Gestión de Usuarios";
            // 
            // BienvenidaLbl
            // 
            ...
            TitolPaginaLbl.Size = new Size(256, 32);
            TitolPaginaLbl.TabIndex = 6;
            TitolPaginaLbl.Text = "Administrar Usuarios";
            // 
            // BuscarUsuariosTxt
            // 
            BuscarUsuariosTxt.BackColor = Color.White;
            BuscarUsuariosTxt.BorderStyle = BorderStyle.FixedSingle;
            BuscarUsuariosTxt.Font = new Font("Segoe UI", 11F, FontStyle.Regular, GraphicsUnit.Point);
            BuscarUsuariosTxt.ForeColor = Color.FromArgb(45, 35, 30);
            BuscarUsuariosTxt.Location = new Point(290, 160);
            BuscarUsuariosTxt.Name = "BuscarUsuariosTxt";
            BuscarUsuariosTxt.Size = new Size(400, 27);
            BuscarUsuariosTxt.TabIndex = 5;
            // 
            // BuscarBtn
            // 
            ...
            // CrearUsuarioBtn
            // 
            CrearUsuarioBtn.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            CrearUsuarioBtn.BackColor = Color.FromArgb(139, 90, 60);
            CrearUsuarioBtn.Cursor = Cursors.Hand;
            CrearUsuarioBtn.FlatAppearance.BorderSize = 0;
            CrearUsuarioBtn.FlatStyle = FlatStyle.Flat;
            CrearUsuarioBtn.Font = new Font("Segoe UI", 11F, FontStyle.Bold, GraphicsUnit.Point);
            CrearUsuarioBtn.ForeColor = Color.White;
            CrearUsuarioBtn.Location = new Point(1120, 157);
            CrearUsuarioBtn.Name = "CrearUsuarioBtn";
            CrearUsuarioBtn.Size = new Size(180, 40);
            CrearUsuarioBtn.TabIndex = 3;
            CrearUsuarioBtn.Text = "➕ Crear Usuario";
            CrearUsuarioBtn.UseVisualStyleBackColor = false;
            CrearUsuarioBtn.Click += CrearUsuarioBtn_Click;
            // 
            // UsuariosDataGrid
            // 
            UsuariosDataGrid.AllowUserToAddRows = false;
            UsuariosDataGrid.AllowUserToDeleteRows = false;
            UsuariosDataGrid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            UsuariosDataGrid.BackgroundColor = Color.White;
            UsuariosDataGrid.BorderStyle = BorderStyle.None;
            ...
            UsuariosDataGrid.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
            UsuariosDataGrid.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            ...
            UsuariosDataGrid.DefaultCellStyle = dataGridViewCellStyle2;
            UsuariosDataGrid.EnableHeadersVisualStyles = false;
            UsuariosDataGrid.GridColor = Color.FromArgb(240, 240, 240);
            UsuariosDataGrid.Location = new Point(290, 220);
            UsuariosDataGrid.MultiSelect = false;
            UsuariosDataGrid.Name = "UsuariosDataGrid";
            UsuariosDataGrid.ReadOnly = true;
            UsuariosDataGrid.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            UsuariosDataGrid.Size = new Size(1070, 440);
            UsuariosDataGrid.TabIndex = 2;
            // 
            // EditarBtn
            // 
            ...
            Controls.Add(UsuariosDataGrid);
            Controls.Add(CrearUsuarioBtn);
            Controls.Add(BuscarBtn);
            Controls.Add(BuscarUsuariosTxt);
            ...
            Text = "Peluquería Bernat Sarriá - Usuarios";
            LateralPanel.ResumeLayout(false);
            CapcaleraPanel.ResumeLayout(false);
            CapcaleraPanel.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)UsuariosDataGrid).EndInit();
