...
namespace PeluqueriaApp
{
    partial class HorarioSemanalForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            CrearBloqueoBtn = new Button();
            BloqueosDataGrid = new DataGridView();
            EditarBtn = new Button();
            EliminarBtn = new Button();
            pbLogo = new PictureBox();
            LateralPanel.SuspendLayout();
            CapcaleraPanel.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)BloqueosDataGrid).BeginInit();
            ...
            // HorarioSemanalBoto
            // 
            HorarioSemanalBoto.BackColor = Color.FromArgb(255, 140, 0);
            ...
            HorarioSemanalBoto.Font = new Font("Segoe UI", 11F, FontStyle.Bold, GraphicsUnit.Point);
            HorarioSemanalBoto.ForeColor = Color.White;
            ...
            TitolAppLbl.Size = new Size(211, 30);
            TitolAppLbl.TabIndex = 0;
            TitolAppLbl.Text = "Horario y Bloqueos";
            // 
            // BienvenidaLbl
            // 
            ...
            TitolPaginaLbl.Size = new Size(355, 32);
            TitolPaginaLbl.TabIndex = 4;
            TitolPaginaLbl.Text = "Gestión de Bloqueos Horarios";
            // 
            // CrearBloqueoBtn
            // 
            CrearBloqueoBtn.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            CrearBloqueoBtn.BackColor = Color.FromArgb(139, 90, 60);
            CrearBloqueoBtn.Cursor = Cursors.Hand;
            CrearBloqueoBtn.FlatAppearance.BorderSize = 0;
            CrearBloqueoBtn.FlatStyle = FlatStyle.Flat;
            CrearBloqueoBtn.Font = new Font("Segoe UI", 11F, FontStyle.Bold, GraphicsUnit.Point);
            CrearBloqueoBtn.ForeColor = Color.White;
            CrearBloqueoBtn.Location = new Point(1100, 157);
            CrearBloqueoBtn.Name = "CrearBloqueoBtn";
            CrearBloqueoBtn.Size = new Size(200, 40);
            CrearBloqueoBtn.TabIndex = 3;
            CrearBloqueoBtn.Text = "➕ Crear Bloqueo";
            CrearBloqueoBtn.UseVisualStyleBackColor = false;
            CrearBloqueoBtn.Click += CrearBloqueoBtn_Click;
            // 
            // BloqueosDataGrid
            // 
            BloqueosDataGrid.AllowUserToAddRows = false;
            BloqueosDataGrid.AllowUserToDeleteRows = false;
            BloqueosDataGrid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            BloqueosDataGrid.BackgroundColor = Color.White;
            BloqueosDataGrid.BorderStyle = BorderStyle.None;
            ...
            BloqueosDataGrid.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle1;
            BloqueosDataGrid.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            ...
            BloqueosDataGrid.DefaultCellStyle = dataGridViewCellStyle2;
            BloqueosDataGrid.EnableHeadersVisualStyles = false;
            BloqueosDataGrid.GridColor = Color.FromArgb(240, 240, 240);
            BloqueosDataGrid.Location = new Point(290, 220);
            BloqueosDataGrid.MultiSelect = false;
            BloqueosDataGrid.Name = "BloqueosDataGrid";
            BloqueosDataGrid.ReadOnly = true;
            BloqueosDataGrid.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            BloqueosDataGrid.Size = new Size(1070, 440);
            BloqueosDataGrid.TabIndex = 2;
            // 
            // EditarBtn
            // 
            ...
            Controls.Add(BloqueosDataGrid);
            Controls.Add(CrearBloqueoBtn);
            Controls.Add(TitolPaginaLbl);
            Controls.Add(CapcaleraPanel);
            Controls.Add(LateralPanel);
            FormBorderStyle = FormBorderStyle.FixedSingle;
            MaximizeBox = false;
            Name = "HorarioSemanalForm";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "Peluquería Bernat Sarriá - Horario Semanal";
            LateralPanel.ResumeLayout(false);
            CapcaleraPanel.ResumeLayout(false);
            CapcaleraPanel.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)BloqueosDataGrid).EndInit();
